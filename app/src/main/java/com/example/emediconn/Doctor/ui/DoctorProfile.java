...
public class DoctorProfile extends Fragment {
    private static final String TAG = String.valueOf(DoctorProfile.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv_medicalregistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                replaceFragmentWithAnimation(new MedicalReg());
            }
        });
        ...
        tv_establishment_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                replaceFragmentWithAnimation(new EstablishmentDetails());
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    @Override public void run() {
                        replaceFragmentWithAnimation(new doctor_profileVerify());
                        dialog.dismiss();

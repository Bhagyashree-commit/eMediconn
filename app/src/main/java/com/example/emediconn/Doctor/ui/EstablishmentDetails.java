 ...
 * Use the {@link EstablishmentDetails#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EstablishmentDetails extends Fragment {
    private static final String TAG = String.valueOf(EstablishmentDetails.class);
    ...
    public static EstablishmentDetails newInstance(String param1, String param2) {
        EstablishmentDetails fragment = new EstablishmentDetails();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_continuehospdetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flag==0) {
                    sendDetailToServer2();
                    replaceFragmentWithAnimation(new EducationDetails());
                }

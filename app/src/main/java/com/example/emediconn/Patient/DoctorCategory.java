...
public class DoctorCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setBackgroundDrawable(getResources().getDrawable(R.drawable.newgradient));

        recyclerView = findViewById(R.id.recyclerView);
        lll = findViewById(R.id.lll);

        ploader = new ProgressDialog(DoctorCategory.this);
        getCategory();
        ...
        public void onBindViewHolder(@NonNull final Holder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(DoctorCategory.this, DoctorDescription.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(DoctorCategory.this, "Connection Time Out.. Please Check Your Internet Connection", duration).show();
                            ...
                            ploader.dismiss();
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DoctorCategory.this, "Your Are Not Authrized..", duration).show();
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DoctorCategory.this, "Server Error", duration).show();
                            //TODO
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DoctorCategory.this, "Please Check Your Internet Connection", duration).show();
                            //TODO
                            ...
                            int duration = Toast.LENGTH_SHORT;
                            Toast.makeText(DoctorCategory.this, "Error While Data Parsing", duration).show();
